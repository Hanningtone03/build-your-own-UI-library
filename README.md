...
A UI component library built in vanilla JavaScript, HTML and CSS; no frameworks or dependencies.

## How it works

Each component is a JavaScript function that creates and returns a DOM element. CSS custom properties handle theming.
## Components
